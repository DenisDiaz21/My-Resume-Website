...
let bigD = document.querySelector(".headerTitle");
let childBanner1Heading = document.querySelector(".childBanner1Heading");
let childBanner1Name = document.querySelector(".childBanner1Name");
let iDevelop = document.querySelector(".iDevelop");
